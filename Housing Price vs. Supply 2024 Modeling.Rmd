...
reg_model_by_1_pred = predict(reg_model_by_1, newdata = X_test)
cor(reg_model_by_1_pred, price_test)

reg_model_by_all_pred = predict(reg_model_by_all, newdata = X_test)
cor(reg_model_by_all_pred, price_test)
