...
#DP05_0002PE – % Male (removed due to collinearity with female)
#DP05_0003PE – % Female
#DP05_0037PE – % White alone
#DP05_0045PE – % Black or African American alone
#DP05_0061PE – % Asian alone
#DP05_0089PE – % Hispanic or Latino (removed due to estimate total)
#DP05_0019PE – % Under 18
#DP05_0029PE – % 65 and over (removed due to estimate total)
...
#DP03_0058PE – % Household income $75,000+

#housing

#DP04_0001PE – Total housing units
#DP04_0046PE – % Owner-occupied
#DP04_0047PE – % Renter-occupied (removed due to collinearity with 'owner-occupied')
#DP04_0019PE – % Units built 2000 or later
...
vars_needed <- c("DP02_0001PE", "DP05_0002PE", "DP05_0003PE", "DP05_0037PE", "DP05_0045PE", "DP05_0061PE", "DP05_0089PE", "DP05_0019PE", "DP05_0029PE", "DP02_0002PE", "DP02_0010PE", "DP02_0006PE", "DP03_0005PE", "DP03_0119PE", "DP02_0068PE", "DP03_0058PE", "DP04_0001PE", "DP04_0046PE", "DP04_0047PE", "DP04_0019PE", "DP04_0003PE")
...
acs1_2024_filtered <- acs1_2024_filtered %>%
  rename(
    ...
    pct_income_75k_plus = DP03_0058PE,
    total_housing_units = DP04_0001PE,
    pct_owner_occupied = DP04_0046PE,
    pct_renter_occupied = DP04_0047PE,
    pct_units_built_2000_plus = DP04_0019PE,
