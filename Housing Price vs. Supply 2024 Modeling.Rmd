...
#baylee- I think the codes don't match, those look like estimates despite being labeled pct ####
```
...
redundant_vars <- full_dataset %>%
  select(ends_with("_mm"), ends_with("_yy"), pct_female, pct_renter_occupied) %>%
  names()
