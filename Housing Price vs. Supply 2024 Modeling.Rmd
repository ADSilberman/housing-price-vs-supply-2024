...
rpart.plot(pruned_tree_data_med,
           type = 2,
           extra = 101,
           under = TRUE,
           fallen.leaves = TRUE,
...
best_cp_log <- reg_tree_exp_log$cptable[which.min(reg_tree_exp_log$cptable[,"xerror"]), "CP"]
best_cp_log
pruned_tree_data_log <- prune(reg_tree_exp_log, 
                              cp = best_cp_log)

options(repr.plot.width = 28, 
        repr.plot.height = 14)

rpart.plot(pruned_tree_data_log,
           type = 2,
           extra = 101,
           under = TRUE,
           fallen.leaves = TRUE,
