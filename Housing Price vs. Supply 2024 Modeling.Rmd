...
census_vars_limited = grepv("*P$", census_vars$name)
...
The list of variables includes what should be the total population as a percent—"DP05_0001P"—but, as that would always be 100%, the wise people at BLS made such equal to "DP05_0001E", the total population estimate, necessitating no further adjustment.
