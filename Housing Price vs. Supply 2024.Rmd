...
ggplot(housing_compare_all, aes(x = reorder(State, -Median_Sale_Price_in_k, median), 
  ...
  coord_flip() +
  labs(
    title = "Distribution of Median Sale Prices by States with Extreme Months' Supply (2024)",
    x = "State",
    y = "Median Sale Price (in thousands)",
    caption = "SOURCE: American Enterprise Institute") +
...
supply12hist <- ggplot(housing_compare_all, 
  ...
  coord_flip() +
  labs(title = "Distribution of Months' Supply by States with Extreme Months' Supply (2024)",
    x = "State",
    y = "Months' Supply",
    caption = "SOURCE: American Enterprise Institute") +
  theme_minimal() +
