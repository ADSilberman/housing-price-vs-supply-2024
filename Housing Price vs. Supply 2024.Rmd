...
```{r boxplot_median_price_by_state_entry}
...
### Histogram of Median Sale Prices (Entry-Level vs. Moveup)
```{r hist_entrylevel_median_price}
...
### Scatterplot: Months of Supply vs Price (Entry-Level)
```{r scatter_supply_vs_price_entry}
...
### Correlation Heatmap of Numeric Variables (Entry-Level)
```{r corr_entrylevel}
housing_numeric <- housing_2024 %>%
