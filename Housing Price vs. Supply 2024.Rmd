...
knitr::opts_chunk$set(echo = TRUE,
                      root.dir = "/Users/ilgazkuscu/Documents/GitHub/housing-price-vs-supply-2024/Data/state_county_data_download_2025.csv"p,
                      warning = F, message = F)
...
```{r clean_data}
housing_2024 = housing %>% filter(housing$Year == 2024, housing$State != 'AA National') %>% na.omit %>% #excluding the armed forces
