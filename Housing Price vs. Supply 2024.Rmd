...
Contrasting the median sale price boxplot distribution above, we see the months' supply boxplot distribution below: 
...
supply12hist <- ggplot(housing_compare_all, 
  ...
  coord_flip() +
  labs(title = "Distribution of Months' Supply (2024)",
    x = "State",
    y = "Months' Supply",
    caption = "SOURCE: American Enterprise Institute") +
  theme_minimal() +
...
The following graph also highlights the relationship between both variables.
