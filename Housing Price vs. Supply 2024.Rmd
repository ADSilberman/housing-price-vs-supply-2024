...
housing_counties_plot2 <- ggplot() +
  geom_sf(data = housing_counties_merge_simple,
          ...
          color = "white",
          linewidth = .4) +
  labs(title = "County-Level Median Home Sale Price in the U.S.",
       subtitle = "Median sale price by county, 2024",
       caption = "Source: AEI Housing Center (2024). Counties in gray have missing or suppressed data.") +
