...
# Create a vector of colors for top states (blue shades) and bottom states (red shades)
top_states_colors_all <- scales::seq_gradient_pal("lightblue", "navy")(seq(0, 1, length.out = length(unique(housing_compare_all$State[housing_compare_all$StateGroup == "States with the Most Houses"]))))
