...
However, in the graph above, there are too many combinations to be particularly useful. You can see general trends, but a smaller sample improves legibility.
...
bottom_states_all %>% 
  ...
  xkabledply
```
By isolating the states with the highest and lowest Months' Supply, we were able to better visualize the difference in how Months' Supply correlates with other variables of interest.
