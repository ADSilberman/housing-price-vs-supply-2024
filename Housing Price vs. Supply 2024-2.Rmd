...
knitr::opts_chunk$set(echo = TRUE,
                      root.dir = "/Users/ilgazkuscu/Documents/GitHub",
                      warning = F, message = F)
...
```
```{r correlation_MoS_price}
# Calculate correlation between Months of Supply and Median Sale Price
correlation_result <- cor(housing_2024_all$Months_Supply,
                          housing_2024_all$Median_Sale_Price_per_k,
                          use = "complete.obs",
                          method = "pearson")

# Print result
cat("Correlation between Months of Supply and Median Sale Price (2024):", 
    round(correlation_result, 3))
